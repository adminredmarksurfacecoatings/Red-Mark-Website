...
// Curated selection of 9 images from /public/Finishes/ for the Stone Collection gallery
const galleryImages = [
  {
    id: 1,
...
export default function StoneCollectionGallery() {
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            {column1.map((item) => (
              ...
              >
                <Image
                  src={item.image}
                  alt={`Stone Collection Application ${item.id}`}
                  fill
