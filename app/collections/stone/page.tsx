      ...
      <section className="page-section page-section--first" style={{ backgroundColor: 'var(--bg-primary)', textAlign: 'center' }}>
        <div className="container" style={{ margin: '0 auto', padding: '0 4rem' }}>
          ...
          <p style={{
            ...
            Layered mineral surfaces designed to bring architectural depth and natural movement to modern spaces.
          </p>
        </div>
      </section>
          ...
          >
            ...
            <div style={{
              ...
              <Image
                ...
                alt="Stone Collection Material Texture"
                fill
            ...
            <div>
              ...
              <p style={{
                ...
                Stone Collection surfaces are designed to bring layered mineral depth to architectural spaces. Each finish reveals subtle movement and tonal variation, creating surfaces that respond beautifully to natural light.
              </p>
            </div>
          </div>
        </div>
